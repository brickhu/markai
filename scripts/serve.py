...
function go(){$('list').innerHTML='loading...';fetch('/api/list?limit=99999').then(function(r){return r.json()}).then(function(d){A=d.entries||d;N=0;$('list').innerHTML='';more()}).catch(function(e){$('s').textContent='Error: '+JSON.stringify(e)})}
